...
# ===================> CONST <==================
B_login = 'font-weight: bold; background-color: white; color: black; font-size: 25px; border-radius:10px'
...
L_close_profile = 'background-color: rgb(227, 154, 9); font-size: 20px;'

Frame = 'background-color: rgb(142, 216, 250); border-radius:0px;'
# \=============== SetStyleSheet ===============/
...
icon_save = "background-color:white; border:0px; border-radius:10px;"
icon_close_profile = "background-color:white; border:0px; border-radius:10px;"
# \================== ICON ==================/
