...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LE_edit_profile_login.setGeometry(QtCore.QRect(355, 320, 310, 50))
        ...
        self.LE_edit_profile_password.setGeometry(QtCore.QRect(355, 400, 310, 50))
        ...
        self.L_edit_profile_1.setGeometry(QtCore.QRect(360, 300, 101, 16))
        self.L_edit_profile_1.setObjectName("L_edit_profile_1")
        self.L_edit_profile_2 = QtWidgets.QLabel(self.page_edit_profile)
        self.L_edit_profile_2.setGeometry(QtCore.QRect(360, 380, 101, 16))
        ...
        self.B_edit_profile_save_login.setGeometry(QtCore.QRect(300, 320, 50, 50))
        ...
        self.B_edit_profile_save_password.setGeometry(QtCore.QRect(300, 400, 50, 50))
        ...
        self.B_edit_profile_warning_1.setGeometry(QtCore.QRect(680, 320, 50, 50))
        ...
        self.B_edit_profile_warning_2.setGeometry(QtCore.QRect(680, 400, 50, 50))
        ...
        self.L_edit_profile_close_profile.setGeometry(QtCore.QRect(360, 630, 181, 31))
        ...
        self.L_edit_profile_warning.setGeometry(QtCore.QRect(360, 280, 301, 20))
        ...
        self.B_edit_profile_close_profile.setGeometry(QtCore.QRect(300, 620, 50, 50))
        ...
        self.B_edit_profile_save_email.setGeometry(QtCore.QRect(300, 480, 50, 50))
        ...
        self.LE_edit_profile_email.setGeometry(QtCore.QRect(355, 480, 310, 50))
        ...
        self.B_edit_profile_warning_3.setGeometry(QtCore.QRect(680, 480, 50, 50))
        ...
        self.L_edit_profile_3.setGeometry(QtCore.QRect(360, 460, 101, 16))
        self.L_edit_profile_3.setObjectName("L_edit_profile_3")
        self.B_edit_profile_ic_code = QtWidgets.QPushButton(self.page_edit_profile)
        self.B_edit_profile_ic_code.setGeometry(QtCore.QRect(300, 560, 50, 50))
        self.B_edit_profile_ic_code.setText("")
        self.B_edit_profile_ic_code.setObjectName("B_edit_profile_ic_code")
        self.LE_edit_profile_code = QtWidgets.QLineEdit(self.page_edit_profile)
        self.LE_edit_profile_code.setGeometry(QtCore.QRect(355, 560, 310, 50))
        self.LE_edit_profile_code.setObjectName("LE_edit_profile_code")
        self.B_edit_profile_warning_4 = QtWidgets.QPushButton(self.page_edit_profile)
        self.B_edit_profile_warning_4.setGeometry(QtCore.QRect(680, 560, 50, 50))
        self.B_edit_profile_warning_4.setText("")
        self.B_edit_profile_warning_4.setObjectName("B_edit_profile_warning_4")
        self.L_edit_profile_4 = QtWidgets.QLabel(self.page_edit_profile)
        self.L_edit_profile_4.setGeometry(QtCore.QRect(360, 540, 101, 16))
        self.L_edit_profile_4.setObjectName("L_edit_profile_4")
        self.L_edit_profile_const_3.raise_()
        self.L_edit_profile_const_1.raise_()
        self.L_edit_profile_const_2.raise_()
        self.L_edit_profile_const_0.raise_()
        self.LE_edit_profile_login.raise_()
        self.LE_edit_profile_password.raise_()
        self.L_edit_profile_1.raise_()
        self.L_edit_profile_2.raise_()
        self.B_edit_profile_save_login.raise_()
        self.B_edit_profile_save_password.raise_()
        self.B_edit_profile_warning_1.raise_()
        self.B_edit_profile_warning_2.raise_()
        self.L_edit_profile_close_profile.raise_()
        self.L_edit_profile_warning.raise_()
        self.B_edit_profile_back.raise_()
        self.B_edit_profile_save_email.raise_()
        self.LE_edit_profile_email.raise_()
        self.B_edit_profile_warning_3.raise_()
        self.L_edit_profile_3.raise_()
        self.B_edit_profile_ic_code.raise_()
        self.LE_edit_profile_code.raise_()
        self.B_edit_profile_warning_4.raise_()
        self.L_edit_profile_4.raise_()
        self.B_edit_profile_close_profile.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.L_edit_profile_4.setText(_translate("MainWindow", "Код:"))
