...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.L_new_user_purple = QtWidgets.QLabel(self.page_new_user)
        self.L_new_user_purple.setGeometry(QtCore.QRect(250, 120, 500, 380))
        self.L_new_user_purple.setText("")
        self.L_new_user_purple.setObjectName("L_new_user_purple")
        self.L_new_user_white = QtWidgets.QLabel(self.page_new_user)
        self.L_new_user_white.setGeometry(QtCore.QRect(250, 280, 500, 380))
        self.L_new_user_white.setText("")
        self.L_new_user_white.setObjectName("L_new_user_white")
        ...
        self.L_new_user_name = QtWidgets.QLabel(self.page_new_user)
        self.L_new_user_name.setGeometry(QtCore.QRect(410, 150, 300, 100))
        self.L_new_user_name.setObjectName("L_new_user_name")
        self.B_new_user_to_user = QtWidgets.QPushButton(self.page_new_user)
        self.B_new_user_to_user.setGeometry(QtCore.QRect(710, 622, 41, 41))
        self.B_new_user_to_user.setText("")
        self.B_new_user_to_user.setObjectName("B_new_user_to_user")
        self.L_new_user_purple.raise_()
        self.L_new_user_white.raise_()
        self.B_new_user_log.raise_()
        self.B_new_user_reg.raise_()
        self.B_new_user_ic_log.raise_()
        self.B_new_user_ic_reg.raise_()
        self.L_new_user_name.raise_()
        self.B_new_user_to_user.raise_()
        self.stackedWidget.addWidget(self.page_new_user)
        self.page_log = QtWidgets.QWidget()
        self.page_log.setObjectName("page_log")
        self.L_log_purple = QtWidgets.QLabel(self.page_log)
        self.L_log_purple.setGeometry(QtCore.QRect(250, 120, 500, 380))
        self.L_log_purple.setText("")
        self.L_log_purple.setObjectName("L_log_purple")
        self.L_log_white = QtWidgets.QLabel(self.page_log)
        self.L_log_white.setGeometry(QtCore.QRect(250, 280, 500, 380))
        self.L_log_white.setText("")
        self.L_log_white.setObjectName("L_log_white")
        self.L_log_name = QtWidgets.QLabel(self.page_log)
        self.L_log_name.setGeometry(QtCore.QRect(410, 150, 300, 100))
        self.L_log_name.setObjectName("L_log_name")
        ...
        self.L_log_purple.raise_()
        self.L_log_white.raise_()
        self.L_log_name.raise_()
        ...
        self.L_reg_purple = QtWidgets.QLabel(self.page_reg)
        self.L_reg_purple.setGeometry(QtCore.QRect(250, 120, 500, 380))
        self.L_reg_purple.setText("")
        self.L_reg_purple.setObjectName("L_reg_purple")
        self.L_reg_white = QtWidgets.QLabel(self.page_reg)
        self.L_reg_white.setGeometry(QtCore.QRect(250, 280, 500, 380))
        self.L_reg_white.setText("")
        self.L_reg_white.setObjectName("L_reg_white")
        self.L_reg_name = QtWidgets.QLabel(self.page_reg)
        self.L_reg_name.setGeometry(QtCore.QRect(410, 150, 300, 100))
        self.L_reg_name.setObjectName("L_reg_name")
        ...
        self.L_reg_purple.raise_()
        self.L_reg_white.raise_()
        self.L_reg_name.raise_()
        ...
        self.L_user_purple = QtWidgets.QLabel(self.page_user)
        self.L_user_purple.setGeometry(QtCore.QRect(250, 120, 500, 380))
        self.L_user_purple.setText("")
        self.L_user_purple.setObjectName("L_user_purple")
        self.L_user_white = QtWidgets.QLabel(self.page_user)
        self.L_user_white.setGeometry(QtCore.QRect(250, 280, 500, 380))
        self.L_user_white.setText("")
        self.L_user_white.setObjectName("L_user_white")
        ...
        self.L_user_name = QtWidgets.QLabel(self.page_user)
        self.L_user_name.setGeometry(QtCore.QRect(410, 150, 300, 100))
        self.L_user_name.setObjectName("L_user_name")
        self.F_user_1 = QtWidgets.QFrame(self.page_user)
        self.F_user_1.setGeometry(QtCore.QRect(250, 190, 70, 91))
        ...
        self.B_user_frame_1.setGeometry(QtCore.QRect(10, 20, 51, 51))
        ...
        self.L_profile_purple = QtWidgets.QLabel(self.page_profile)
        self.L_profile_purple.setGeometry(QtCore.QRect(250, 120, 500, 380))
        self.L_profile_purple.setText("")
        self.L_profile_purple.setObjectName("L_profile_purple")
        self.L_profile_white = QtWidgets.QLabel(self.page_profile)
        self.L_profile_white.setGeometry(QtCore.QRect(250, 280, 500, 380))
        self.L_profile_white.setText("")
        self.L_profile_white.setObjectName("L_profile_white")
        self.L_profile_name = QtWidgets.QLabel(self.page_profile)
        self.L_profile_name.setGeometry(QtCore.QRect(410, 150, 300, 100))
        self.L_profile_name.setObjectName("L_profile_name")
        ...
        self.L_edit_profile_purple = QtWidgets.QLabel(self.page_edit_profile)
        self.L_edit_profile_purple.setGeometry(QtCore.QRect(250, 120, 500, 380))
        self.L_edit_profile_purple.setText("")
        self.L_edit_profile_purple.setObjectName("L_edit_profile_purple")
        self.L_edit_profile_white = QtWidgets.QLabel(self.page_edit_profile)
        self.L_edit_profile_white.setGeometry(QtCore.QRect(250, 280, 500, 380))
        self.L_edit_profile_white.setText("")
        self.L_edit_profile_white.setObjectName("L_edit_profile_white")
        self.L_edit_profile_name = QtWidgets.QLabel(self.page_edit_profile)
        self.L_edit_profile_name.setGeometry(QtCore.QRect(320, 150, 411, 100))
        self.L_edit_profile_name.setObjectName("L_edit_profile_name")
        ...
        self.L_edit_profile_3.setGeometry(QtCore.QRect(300, 530, 181, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.L_new_user_name.setText(_translate("MainWindow", "HELLO!"))
        self.L_log_name.setText(_translate("MainWindow", "LOG IN!"))
        self.B_log_save.setText(_translate("MainWindow", " ✰ GET IN ✰"))
        self.L_reg_name.setText(_translate("MainWindow", "REG IN!"))
        self.B_reg_save.setText(_translate("MainWindow", "✰ CREATE ✰"))
        self.L_user_name.setText(_translate("MainWindow", "ALL GOOD!"))
        self.L_profile_name.setText(_translate("MainWindow", "PROFILE"))
        self.L_profile_1.setText(_translate("MainWindow", "Ваш логин:"))
        self.L_profile_2.setText(_translate("MainWindow", "Ваш пароль:"))
        self.L_edit_profile_name.setText(_translate("MainWindow", "EDIT PROFILE"))
        ...
        self.L_edit_profile_3.setText(_translate("MainWindow", "Закрытый профиль"))
